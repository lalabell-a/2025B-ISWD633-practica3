...
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_EMAIL=admin@drupal.com -e PGADMIN_DEFAULT_PASSWORD=54321 --network net-drupal dpage/pgadmin4
```
...
```
docker run -d --name server-drupal -p 9700:80 -v vol-drupal-modules:/var/www/html/modules -v vol-drupal-profiles:/var/www/html/profiles -v vol-drupal-sites:/var/www/html/sites -v vol-drupal-themes:/var/www/html/themes --network net-drupal drupal
